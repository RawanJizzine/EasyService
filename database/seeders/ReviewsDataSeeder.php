    ...
    public function run()
    {
        $reviewsData = [
            [
                ...
                'image' => 'uploads/images/reviews/1.png',
                'position' => 'CEO of Airbnb',
                'rating' => 5,
                'icon'=>'uploads/images/reviews/7.png',
            ],
            [
                'name' => 'Eugenia Moore',
                ...
                'image' =>'uploads/images/reviews/2.png',
                'position' => 'Founder of Hubspot',
                'rating' => 5,
                'icon'=>'uploads/images/reviews/8.png',
            ],
            [
                ...
                'image' => 'uploads/images/reviews/3.png',
                'position' => 'Design Lead at Dribbble',
                'rating' => 5,
                'icon'=>'uploads/images/reviews/9.png',
            ],
            [
                'name' => 'Sara Smith',
                ...
                'image' => 'uploads/images/reviews/4.png',
                'position' => 'Founder of Continental',
                'rating' => 4,
                'icon'=>'uploads/images/reviews/10.png',
            ],
            [
                'name' => 'Eugenia Moore',
                'description' => '“I\'ve never used a theme as versatile and flexible as Vuexy. It\'s my go to for building dashboard sites on almost any project.”',
                'image' => 'uploads/images/reviews/5.png',
                'position' => 'Founder of Hubspot',
                'rating' => 5,
                'icon'=>'uploads/images/reviews/11.png',
            ],
            [
                'name' => 'Sara Smith',
                ...
                'image' => 'uploads/images/reviews/6.png',
                'position' => 'Founder of Continental',
                'rating' => 4,
                'icon'=>'uploads/images/reviews/12.png',
            ],
        ];
